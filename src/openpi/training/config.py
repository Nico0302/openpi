...
import openpi.policies.leros2_policy as leros2_policy
...
class LeROS2DataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        # replace the transforms below with your own.
        data_transforms = _transforms.Group(
            inputs=[leros2_policy.LeROS2Inputs(model_type=model_config.model_type)],
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_leros2",
        data=LeROS2DataConfig(repo_id="physical-intelligence/libero", base_config=DataConfig(prompt_from_task=False)),
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
