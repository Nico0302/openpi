...
class LeROS2Inputs(transforms.DataTransformFn):
    """
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # Rename action to actions to match the model's expected input format.
...
@dataclasses.dataclass(frozen=True)
class LeROS2Outputs(transforms.DataTransformFn):
    """
